...
public class UserProfileServiceRouteLocatorBeanConfig {
    @Value(value = "${az.rock.ws.values.service-names.user-profile-service}")
    private  String serviceName;

    @Value(value = "${az.rock.ws.values.api.user-profile.private}")
    private  String privateApi;

    @Value(value = "${az.rock.ws.values.api.user-profile.public}")
